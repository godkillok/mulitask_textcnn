...
flags.DEFINE_string("train_file", "/data/tanggp/company_data/author_text_cnn_txt_train_*", "train file pattern")
flags.DEFINE_string("valid_file", "/data/tanggp/company_data/author_text_cnn_txt_test_*", "train file pattern")
...
flags.DEFINE_string("params_file", "/data/tanggp/company_data/dataset_params.json", "parameters file")
flags.DEFINE_string("word_path", "/data/tanggp/company_data/words.txt", "word vocabulary file")
flags.DEFINE_string("model_dir", "/data/tanggp/textcnn_baseline_model_v3", "Path to save model")
flags.DEFINE_string("result_file", "/data/tanggp/textcnn_baseline_model_v3/base_result.txt", "Path to save predict result")
