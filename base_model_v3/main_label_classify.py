...
flags.DEFINE_string("train_file", "/data/tanggp/company_data/author_text_cnn_train_*", "train file pattern")
flags.DEFINE_string("valid_file", "/data/tanggp/company_data/author_text_cnn_test_*", "train file pattern")
