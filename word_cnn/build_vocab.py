...
parser.add_argument('--data_dir', default='/data/tanggp/company_data/', help="Directory containing the dataset")
...
if __name__ == '__main__':
    ...
    words_=[PAD_WORD,'v_oov']
    words_ += [tok for tok, count in words.items() if count >= args.min_count_word if tok not in words_]
    ...
    save_vocab_to_txt_file(words_, os.path.join(args.data_dir, 'words.txt'))
    print("- done.")
